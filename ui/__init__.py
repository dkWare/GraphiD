...
class TicTacToeButton(RectButton):
    def __init__(self, game, row, column, center_x, center_y, ui_manager):
        ...
        self.set_color_masked(arcade.color.WHITE_SMOKE)
        self.set_color_unmasked(arcade.color.ASH_GREY)
        self.debug = False
...
class TicTacToe(arcade.Window):
    def __init__(self):
        ...
        self.gui_manager = UIManager(self.mouse_pointer)
    ...
    def create_reset_button(self):
        reset_button = RectButton("reset",text="Reset",
                                      center_x=100,
                                      center_y=100,
                                      height=50,
                                      width=100,
        ...
        reset_button.set_color_masked(arcade.color.WHITE_SMOKE)
        reset_button.set_color_unmasked(arcade.color.ASH_GREY)
