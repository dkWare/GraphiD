...
class UIManager:
    ...
    def raise_scroll_event(self, scroll_x: int, scroll_y: int):
        dbg.info("MOUSE SCROLL EVENT start iterating all fields", extra={"tags": [_debugger_tags.EVENTS, _debugger_tags.M_MANAGE, _debugger_tags.MOUSE], 'classname': self.__class__.__name__})
        for field in self.field_list:
            field.raise_scroll_event(scroll_x, scroll_y)
...
class EventTemplate:
    ...
    def on_mouse_scroll(self, x: int, y: int, scroll_x: int, scroll_y: int):
        self.ui_manager.raise_scroll_event(scroll_x, scroll_y)
